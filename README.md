...
# Day 11 – Power BI Dashboard 1: Executive Overview

## Objective
Built the first interactive Power BI dashboard to present a high-level business overview of Customer Lifetime Value (CLTV), Revenue, and Customer Segmentation. The dashboard is designed for executives to quickly understand customer performance and identify high-value customer segments.
...
## Dashboard Created
### Executive Overview | Customer CLTV Analysis

## KPI Cards
Created five business KPIs using DAX Measures:
...
- Shows total revenue generated by each CLTV segment.

### 2. CLTV by Customer Segment
- Clustered Bar Chart
- Compares total customer lifetime value across segments.

### 3. Customer Distribution
- Donut Chart
- Displays customer percentage across CLTV segments.

### 4. Revenue vs CLTV Comparison
- Line & Clustered Column Chart
- Compares Revenue and CLTV simultaneously for each customer segment.

## Business Insights

- Segment A contributes the highest Revenue and CLTV.
- Customer distribution is nearly balanced across all segments.
- Premium customers generate the majority of business value.
- Dashboard enables quick executive-level performance monitoring.

## Validation

- All DAX measures validated with Python outputs.
- KPI values matched previously generated datasets.
- All visual aggregations cross-checked successfully.
- Dashboard completed without data inconsistencies.

##  Outcome

Successfully completed the first Power BI Executive Dashboard, providing a professional overview of customer value, revenue contribution, and CLTV segmentation for business decision-making.
